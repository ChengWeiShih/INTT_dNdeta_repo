...
void test_z()
{
    ...
    string out_folder_directory = input_directory + "/codetest_" + file_name;
    ...
    INTTZvtx     * MCz     = new INTTZvtx(out_folder_directory, beam_origin, geo_mode_id, phi_diff_cut, DCA_cut, N_clu_cutl, N_clu_cut, zvtx_cal_require, draw_event_display, peek);
