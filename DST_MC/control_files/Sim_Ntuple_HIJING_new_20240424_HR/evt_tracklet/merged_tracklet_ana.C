...
int merged_tracklet_ana()
{
    ...
    for (int i = 0; i < dNdeta_1D_fulleta_MC_1.size(); i++)
    {
        ...
        legend -> AddEntry(dNdeta_1D_reco_single_1[0], "corr. reco.", "ep");
        legend -> AddEntry(dNdeta_1D_fulleta_MC_2[0], "test true", "f");
        legend -> AddEntry(dNdeta_1D_reco_single_2[0], "test reco.", "ep");
        legend -> Draw("same");
    ...
    for (int i = 0; i < dNdeta_1D_fulleta_MC_1.size(); i++)
    {
        ...
        legend -> AddEntry(dNdeta_1D_fulleta_MC_1[0], "corr. true", "f");
        legend -> AddEntry(dNdeta_1D_reco_multi_1[0], "corr. reco.", "ep");
        legend -> AddEntry(dNdeta_1D_fulleta_MC_2[0], "test true", "f");
        legend -> AddEntry(dNdeta_1D_reco_multi_2[0], "test reco.", "ep");
