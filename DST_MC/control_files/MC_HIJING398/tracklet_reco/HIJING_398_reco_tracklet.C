...
void HIJING_398_reco_tracklet()
{
    ...
    string out_folder_directory1 = input_directory1 + "/eta_closer_out_test_SingleZBin_half_corr";
    ...
    string out_folder_directory2 = input_directory2 + "/eta_closer_out_test_SingleZBin_half_test";
