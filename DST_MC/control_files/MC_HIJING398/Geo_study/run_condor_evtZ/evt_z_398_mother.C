...
void evt_z_398_mother(int core_i, int loop_i)
{
    ...
    TFile * file_geo_XY = TFile::Open(Form("%s/Geo_XY_scan_trial_1/complete_file/full_merged_file/geo_scan_%i_merged.root", input_directory.c_str(),core_i));
    ...
    string out_folder_directory = input_directory + "/Geo_Z_scan_trial_1"+"/random_seed_"+to_string(in_random_seed);
    ...
    pair<double, double> beam_origin = {(in_cornerX+in_centerX)/2., (in_cornerY+in_centerY)/2.};
