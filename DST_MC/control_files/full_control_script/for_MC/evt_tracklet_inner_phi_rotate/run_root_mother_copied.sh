...
root -l -b -q /sphenix/user/ChengWei/INTT/INTT_dNdeta_repo/DST_MC/control_files/full_control_script/for_MC/evt_tracklet_inner_phi_rotate/evtTracklet_mother.C\(${core_i}\)
