...
root -l -b -q /sphenix/user/ChengWei/INTT/INTT_dNdeta_repo/DST_MC/control_files/full_control_script/for_MC/evt_tracklet/evtTracklet_mother.C\(${core_i},\"evt_tracklet_Original_MC_zvtxshifted_weighting\",\"evt_vtxZ\"\)
