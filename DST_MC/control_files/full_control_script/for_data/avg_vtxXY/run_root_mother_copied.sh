...
root -l -b -q /sphenix/user/ChengWei/INTT/INTT_dNdeta_repo/DST_MC/control_files/full_control_script/for_data/avg_vtxXY/avgXY_mother.C\(${core_i},\"avg_vtxXY_post\"\)
