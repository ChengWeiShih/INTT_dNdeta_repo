...
root -l -b -q control_file_to_be_updated/evt_tracklet_inner_phi_rotate/evtTracklet_mother.C\(${core_i},\"output_sub_folder_name_to_be_updated\",\"used_zvtx_folder_name_to_be_updated\"\)
