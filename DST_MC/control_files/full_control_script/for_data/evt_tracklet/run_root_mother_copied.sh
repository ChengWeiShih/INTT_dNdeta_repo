...
root -l -b -q /sphenix/user/ChengWei/INTT/INTT_dNdeta_repo/DST_MC/control_files/full_control_script/for_data/evt_tracklet/evtTracklet_mother.C\(${core_i},\"evt_tracklet_ZvtxRange_n300mm_to_n60mm\",\"evt_vtxZ\"\)
