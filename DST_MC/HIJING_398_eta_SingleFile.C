...
void HIJING_398_eta_SingleFile()
{
    ...
    string input_directory1 = "/sphenix/user/ChengWei/sPH_dNdeta/HIJING_ana398_xvtx-0p04cm_yvtx0p24cm_zvtx-20cm_dummyAlignParams/CodeTest1_combine_FullZ_TrackEta_MC_ZF_zvtx";
    string input_file1 = "INTT_final_hist_info.root";
    string out_folder_directory1 = input_directory1 + "/eta_closer_out_test_SingleZBin";
    bool Mbin_Z_evt_map_name_bool1 = 1;

    string input_directory2 = "/sphenix/user/ChengWei/sPH_dNdeta/HIJING_ana398_xvtx-0p04cm_yvtx0p24cm_zvtx-20cm_dummyAlignParams/CodeTest1_combine_FullZ_TrackEta_MC_ZF_RECO_zvtx";
