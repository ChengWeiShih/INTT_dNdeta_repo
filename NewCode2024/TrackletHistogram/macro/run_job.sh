...
root.exe -q -b Run_PrepareHist.C\(${process},${runnumber},${nEvents},\"${input_directory}\",\"${input_filename}\",\"${output_directory}\"\)


echo all done process the Run_PrepareHist.C, process_id ${process}
