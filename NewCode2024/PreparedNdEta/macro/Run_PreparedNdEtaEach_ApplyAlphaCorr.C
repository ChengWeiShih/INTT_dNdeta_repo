...
void Run_PreparedNdEtaEach_ApplyAlphaCorr(
  ...
  string input_filename = "MC_TrackletHistogram_INTT_vtxZ_QA_test_N0p07to0p07_nbin140_merged_002.root",
  ...
  string alpha_correction_input_directory = "/sphenix/tg/tg01/commissioning/INTT/work/cwshih/sPH_dNdeta/Run24AuAuMC/Sim_Ntuple_HIJING_ana443_20241102/Run24NewCode_dNdEta/completed/MC_PreparedNdEtaEach_AllSensor_VtxZ_10Mbin_100_test_N0p07to0p07_nbin140_00001_dNdEta.root"
)
{
  ...
  PNEE -> SetSelectedEtaRange({-1.9, 1.9});
